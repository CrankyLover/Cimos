...
matching::matching(std::vector<Graph>& query_graphs, Graph& data_graph)
: querys_(query_graphs)
, data_(data_graph)

, max_num_results_(ULONG_MAX)
, print_preprocessing_results_(true)
, print_enumeration_results_(false)
, homomorphism_(false)
